...
public class ProductsController : ControllerBase
{
    ...
    {
        _logger.LogInformation("Creating new product '{ProductName}' with SKU '{Sku}'.", dto.Name, dto.Sku);
    ...
    {
        _logger.LogInformation("Restocking product with ID {ProductId} by quantity {QuantityToAdd}.", id, dto.QuantityToAdd);
